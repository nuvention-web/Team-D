  ...
  render() {
    return (
      <form>
        ...
        <h1 id="platforms" className="platforms-menu">Timeframe</h1>
            <label id = "ld_label"><input type="checkbox" id="cb" label={"24 hours"} checked={this.isFB} onChange={this.handleFBChange}/>24 hours</label><br/>
            <label id = "ld_label"><input type="checkbox" id="cb" label={"7 days"} checked={this.isYT} onChange={this.handleYTChange}/>7 days</label><br/>
      </form>
    )
  }
}